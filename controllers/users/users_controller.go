...
func Index(w http.ResponseWriter, r *http.Request) {
  t, _ := template.ParseFiles("views/movies/index.html") //indicamos la ruta del template/html
...
func Show(w http.ResponseWriter, r *http.Request) {
  ...
  t, _ := template.ParseFiles("views/movies/show.html") //indicamos a ruta del template
